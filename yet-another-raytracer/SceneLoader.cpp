...
void SceneLoader::CreateProcessors(ProcessorMap & command_map, ProcessorCollection & processors, const std::experimental::filesystem::path& sceneFileName ) const
{
...
void SceneLoader::Load(Scene & scene, const std::experimental::filesystem::path& filename) const
{
	std::ifstream stream;

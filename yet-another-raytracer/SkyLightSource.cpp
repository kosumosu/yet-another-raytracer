...
void SkyLightSource::IterateOverFluxes(const LightingContext & context, const RayEvaluator & rayEvaluator, const flux_func & job) const
{
	...
	{
		auto direction = math::hemiSphericalRand(context.getNormal());

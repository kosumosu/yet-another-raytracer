...
#include "base_vector_functions.hpp"
#include "base_vector3.hpp"
#include "base_vector3_operations.hpp"
#include "base_vector4.hpp"
...
namespace math
{
	typedef base_vector<float, 3> vector3f;
	typedef base_vector<float, 4> vector4f;
	typedef base_vector<double, 3> vector3d;
	typedef base_vector<double, 4> vector4d;

...
public:
	...
	Hit TraceRay(const ray3 & ray, space_real minDistance, space_real maxDistance, const GeometryObject * objectToIgnore, bool ignoreBackFace) const;
	bool DoesIntersect(const ray3 & ray, space_real minDistance, space_real maxDistance, const GeometryObject * objectToIgnore, bool ignoreBackFace) const;

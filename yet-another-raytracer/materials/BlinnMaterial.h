...
namespace materials
{
    ...
    public:
        ...
        BlinnMaterial(color_rgb emission, const Texture* diffuseMap, color_rgb diffuse, color_rgb specular,
                      color_real shininess, color_rgb translucency)
        ...
        [[nodiscard]] color_rgb EvaluateTransmittance(
            const objects::GeometryObject& object,
            const vector3& hitPoint,
            const vector3& normal,
            const uvs_t& uvs,

...
namespace hashing
{
	constexpr uint32_t xxhash32(uint32_t p)
	{
	...
	constexpr uint32_t xxhash32(const math::vector<uint32_t, 2>& vec)
	{
		const uint32_t PRIME32_2 = 2246822519U, PRIME32_3 = 3266489917U;
		const uint32_t PRIME32_4 = 668265263U, PRIME32_5 = 374761393U;
	...
	constexpr uint32_t xxhash32(const math::vector<uint32_t, 3>& vec)
	{
		const uint32_t PRIME32_2 = 2246822519U, PRIME32_3 = 3266489917U;
		const uint32_t PRIME32_4 = 668265263U, PRIME32_5 = 374761393U;
	...
	constexpr uint32_t xxhash32(const math::vector<uint32_t, 4>& vec)
	{
		const uint32_t PRIME32_2 = 2246822519U, PRIME32_3 = 3266489917U;
		const uint32_t PRIME32_4 = 668265263U, PRIME32_5 = 374761393U;

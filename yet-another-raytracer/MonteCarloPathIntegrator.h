...
private:
	...
	color_rgbx EvaluateRadianceByLightsAtVertex(const ray3 & currentRay, const Hit & hit, const bsdf_distribution & bsdfDistribution, math::UniformRandomBitGenerator<unsigned> & randomEngine) const;
};
